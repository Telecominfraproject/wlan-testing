...
def get_ip_address_maverick2_ios(request, WifiName, WifiPass, setup_perfectoMobile, connData):
    print("\n-------------------------------------")
    print("Select Wifi/AccessPoint Connection")
    print("-------------------------------------")
...
def get_ip_address_maverick_iOS(request, WifiName, WifiPass, setup_perfectoMobile, connData):
    print("\n-------------------------------------")
    print("Select Wifi/Get IP Address IOS Connection")
    print("-------------------------------------")
...
def return_open_maverickpage_iOS(request, setup_perfectoMobile_iOS, get_APToMobileDevice_data):
    print("\n-------------------------------------")
