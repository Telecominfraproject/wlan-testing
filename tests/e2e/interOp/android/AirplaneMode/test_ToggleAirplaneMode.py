...
class TestToggleAirplaneModeAndroid(object):
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    def test_ToggleAirplaneMode_5g_OPEN(self, request, get_vif_state, get_ToggleAirplaneMode_data, setup_perfectoMobile_android):
    ...
    @pytest.mark.open
    @pytest.mark.twog
    def test_ToggleAirplaneMode_2g_OPEN(self, request, get_vif_state, get_ToggleAirplaneMode_data, setup_perfectoMobile_android):
