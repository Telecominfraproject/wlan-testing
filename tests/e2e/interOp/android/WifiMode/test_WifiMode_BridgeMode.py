...
class TestToggleWifiModeBridge(object):
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    def test_ToogleAirplaneMode_5g_OPEN_BRIDGE(self, request, get_vif_state, get_ToggleWifiMode_data, setup_perfectoMobile_android):
    ...
    @pytest.mark.open
    @pytest.mark.twog
    def test_ToogleAirplaneMode_2g_OPEN_BRIDGE(self, request, get_vif_state, get_ToggleWifiMode_data, setup_perfectoMobile_android):
