...
class TestPassPointConnection(object):
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    def test_PassPointConnection_5g_OPEN(self, request, get_vif_state, get_PassPointConniOS_data, setup_perfectoMobile_iOS):
    ...
    @pytest.mark.open
    @pytest.mark.twog
    def test_PassPointConnection_2g_OPEN(self, request, get_vif_state, get_PassPointConniOS_data, setup_perfectoMobile_iOS):
    ...
    def test_PassPointConnection_5g_WPA2_Personal(self, request, get_vif_state, setup_perfectoMobile_iOS, get_PassPointConniOS_data):
    ...
    @pytest.mark.twog
    @pytest.mark.wpa2_personal
    def test_PassPointConnection_2g_WPA2_Personal(self, request, get_vif_state, setup_perfectoMobile_iOS, get_PassPointConniOS_data):
    ...
    @pytest.mark.twog
    @pytest.mark.wpa
    def test_PassPointConnection_2g_WPA(self, request, get_vif_state, setup_perfectoMobile_iOS, get_PassPointConniOS_data):
    ...
    @pytest.mark.fiveg
    @pytest.mark.wpa
    def test_PassPointConnection_5g_WPA(self, request, get_vif_state, setup_perfectoMobile_iOS, get_PassPointConniOS_data):
