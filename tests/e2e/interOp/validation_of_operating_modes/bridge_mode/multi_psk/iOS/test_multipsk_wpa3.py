...
class TestMultipskBridge(object):
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7129", name="WIFI-7129")
    @pytest.mark.wpa3_personal
    @pytest.mark.twog
    def test_multi_psk_wpa3_2g_2vlans(self, request, get_vif_state, get_ap_logs, lf_tools, get_configuration,
        ...
        ip1, is_internet1 = get_ip_address_ios(request, ssidName, key1, setup_perfectoMobile_iOS, connData)
        #
        if ip1:
            if is_internet1:
            ...
            assert False
        time.sleep(5)
        ip2, is_internet2 = get_ip_address_ios(request, ssidName, key2, setup_perfectoMobile_iOS, connData)
        #
        if ip2:
            if is_internet2:
            ...
            allure.attach(name="Connection Status: ", body=str("Device is Unable to connect"))
            assert False
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7130", name="WIFI-7130")

    @pytest.mark.wpa3_personal
    @pytest.mark.fiveg
    def test_multi_psk_wpa3_5g_2vlans(self, request, get_vif_state, get_ap_logs, lf_tools,
                                      get_ToggleAirplaneMode_data, setup_perfectoMobile_iOS):
    ...
    # -------------4 Vlans----------------------------------
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7131", name="WIFI-7131")

    @pytest.mark.wpa3_personal
    @pytest.mark.twog
    def test_multi_psk_wpa3_2g_4vlans(self, request, get_vif_state, get_ap_logs, lf_tools, get_configuration,
                                      get_ToggleAirplaneMode_data, setup_perfectoMobile_iOS):
        profile_data = setup_params_general["ssid_modes"]["wpa3_personal"][0]
        ssidName = profile_data["ssid_name"]
        ssidPassword = profile_data["security_key"]
        ...
        if ip2:
            ...
            assert False
        time.sleep(5)
        ip3, is_internet3 = get_ip_address_ios(request, ssidName, key3, setup_perfectoMobile_iOS, connData)
        #
        if ip3:
            if is_internet3:
            ...
            assert False
        time.sleep(5)
        ip4, is_internet4 = get_ip_address_ios(request, ssidName, key4, setup_perfectoMobile_iOS, connData)
        #
        if ip4:
            if is_internet4:
            ...
            allure.attach(name="Connection Status: ", body=str("Device is Unable to connect"))
            assert False
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7132", name="WIFI-7132")

    @pytest.mark.wpa3_personal
    @pytest.mark.fiveg
    def test_multi_psk_wpa3_5g_4vlans(self, request, get_vif_state, get_ap_logs, lf_tools,
                                      get_ToggleAirplaneMode_data, setup_perfectoMobile_iOS):
        profile_data = setup_params_general["ssid_modes"]["wpa3_personal"][1]
        ssidName = profile_data["ssid_name"]
        ssidPassword = profile_data["security_key"]
    ...
    # -------------8 Vlans----------------------------------
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7133", name="WIFI-7133")

    @pytest.mark.wpa3_personal
    @pytest.mark.twog
    def test_multi_psk_wpa3_2g_8vlans(self, request, get_vif_state, get_ap_logs, lf_tools, get_configuration,
                                      get_ToggleAirplaneMode_data, setup_perfectoMobile_iOS):
        profile_data = setup_params_general["ssid_modes"]["wpa3_personal"][0]
        ssidName = profile_data["ssid_name"]
        ssidPassword = profile_data["security_key"]
        ...
        if ip4:
            ...
            assert False
        time.sleep(5)
        ip5, is_internet5 = get_ip_address_ios(request, ssidName, key5, setup_perfectoMobile_iOS, connData)
        #
        if ip5:
            if is_internet5:
            ...
            assert False
        time.sleep(5)
        ip6, is_internet6 = get_ip_address_ios(request, ssidName, key6, setup_perfectoMobile_iOS, connData)
        #
        if ip6:
            if is_internet6:
            ...
            assert False
        time.sleep(5)
        ip7, is_internet7 = get_ip_address_ios(request, ssidName, key7, setup_perfectoMobile_iOS, connData)
        #
        if ip7:
            if is_internet7:
            ...
            assert False
        time.sleep(5)
        ip8, is_internet8 = get_ip_address_ios(request, ssidName, key8, setup_perfectoMobile_iOS, connData)
        #
        if ip8:
            if is_internet8:
            ...
            allure.attach(name="Connection Status: ", body=str("Device is Unable to connect"))
            assert False
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7134", name="WIFI-7134")

    @pytest.mark.wpa3_personal
    @pytest.mark.fiveg
    def test_multi_psk_wpa3_5g_8vlans(self, request, get_vif_state, get_ap_logs, lf_tools,
                                      get_ToggleAirplaneMode_data, setup_perfectoMobile_iOS):
        profile_data = setup_params_general["ssid_modes"]["wpa3_personal"][1]
        ssidName = profile_data["ssid_name"]
        ssidPassword = profile_data["security_key"]
    ...
    # -------------16 Vlans----------------------------------
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7135", name="WIFI-7135")

    @pytest.mark.wpa3_personal
    @pytest.mark.twog
    def test_multi_psk_wpa3_2g_16vlans(self, request, get_vif_state, get_ap_logs, lf_tools, get_configuration,
                                       get_ToggleAirplaneMode_data, setup_perfectoMobile_iOS):
        profile_data = setup_params_general["ssid_modes"]["wpa3_personal"][0]
        ssidName = profile_data["ssid_name"]
        ssidPassword = profile_data["security_key"]
        ...
        if ip8:
            ...
            assert False
        time.sleep(5)
        ip9, is_internet9 = get_ip_address_ios(request, ssidName, key9, setup_perfectoMobile_iOS, connData)
        #
        if ip9:
            if is_internet9:
            ...
            assert False
        time.sleep(5)
        ip10, is_internet10 = get_ip_address_ios(request, ssidName, key10, setup_perfectoMobile_iOS, connData)
        #
        if ip10:
            if is_internet10:
            ...
            assert False
        time.sleep(5)
        ip11, is_internet11 = get_ip_address_ios(request, ssidName, key11, setup_perfectoMobile_iOS, connData)
        #
        if ip11:
            if is_internet11:
            ...
            assert False
        time.sleep(5)
        ip12, is_internet12 = get_ip_address_ios(request, ssidName, key12, setup_perfectoMobile_iOS, connData)
        #
        if ip12:
            if is_internet12:
            ...
            assert False
        time.sleep(5)
        ip13, is_internet13 = get_ip_address_ios(request, ssidName, key13, setup_perfectoMobile_iOS, connData)
        #
        if ip13:
            if is_internet5:
            ...
            assert False
        time.sleep(5)
        ip14, is_internet14 = get_ip_address_ios(request, ssidName, key14, setup_perfectoMobile_iOS, connData)
        #
        if ip14:
            if is_internet14:
            ...
            assert False
        time.sleep(5)
        ip15, is_internet15 = get_ip_address_ios(request, ssidName, key15, setup_perfectoMobile_iOS, connData)
        #
        if ip15:
            if is_internet15:
            ...
            assert False
        time.sleep(5)
        ip16, is_internet16 = get_ip_address_ios(request, ssidName, key16, setup_perfectoMobile_iOS, connData)
        #
        if ip16:
            if is_internet16:
            ...
            allure.attach(name="Connection Status: ", body=str("Device is Unable to connect"))
            assert False
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7136", name="WIFI-7136")

    @pytest.mark.wpa3_personal
    @pytest.mark.fiveg
    def test_multi_psk_wpa3_5g_16vlans(self, request, get_vif_state, get_ap_logs, lf_tools, get_configuration,
        ...
        ip1, is_internet1 = get_ip_address_ios(request, ssidName, key1, setup_perfectoMobile_android, connData)
        #
        if ip1:
            if is_internet1:
                text_body = ("connected to " + ssidName + " (" + ip1 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip2, is_internet2 = get_ip_address_ios(request, ssidName, key2, setup_perfectoMobile_android, connData)
        #
        if ip2:
            if is_internet2:
                text_body = ("connected to " + ssidName + " (" + ip2 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip3, is_internet3 = get_ip_address_ios(request, ssidName, key3, setup_perfectoMobile_android, connData)
        #
        if ip3:
            if is_internet3:
                text_body = ("connected to " + ssidName + " (" + ip3 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip4, is_internet4 = get_ip_address_ios(request, ssidName, key4, setup_perfectoMobile_android, connData)
        #
        if ip4:
            if is_internet4:
                text_body = ("connected to " + ssidName + " (" + ip4 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip5, is_internet5 = get_ip_address_ios(request, ssidName, key5, setup_perfectoMobile_android, connData)
        #
        if ip5:
            if is_internet5:
                text_body = ("connected to " + ssidName + " (" + ip5 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip6, is_internet6 = get_ip_address_ios(request, ssidName, key6, setup_perfectoMobile_android, connData)
        #
        if ip6:
            if is_internet6:
                text_body = ("connected to " + ssidName + " (" + ip6 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip7, is_internet7 = get_ip_address_ios(request, ssidName, key7, setup_perfectoMobile_android, connData)
        #
        if ip7:
            if is_internet7:
                text_body = ("connected to " + ssidName + " (" + ip7 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip8, is_internet8 = get_ip_address_ios(request, ssidName, key8, setup_perfectoMobile_android, connData)
        #
        if ip8:
            if is_internet8:
                text_body = ("connected to " + ssidName + " (" + ip8 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip9, is_internet9 = get_ip_address_ios(request, ssidName, key9, setup_perfectoMobile_android, connData)
        #
        if ip9:
            if is_internet9:
                text_body = ("connected to " + ssidName + " (" + ip9 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip10, is_internet10 = get_ip_address_ios(request, ssidName, key10, setup_perfectoMobile_android, connData)
        #
        if ip10:
            if is_internet10:
                text_body = ("connected to " + ssidName + " (" + ip10 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip11, is_internet11 = get_ip_address_ios(request, ssidName, key11, setup_perfectoMobile_android, connData)
        #
        if ip11:
            if is_internet11:
                text_body = ("connected to " + ssidName + " (" + ip11 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip12, is_internet12 = get_ip_address_ios(request, ssidName, key12, setup_perfectoMobile_android, connData)
        #
        if ip12:
            if is_internet12:
                text_body = ("connected to " + ssidName + " (" + ip12 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip13, is_internet13 = get_ip_address_ios(request, ssidName, key13, setup_perfectoMobile_android, connData)
        #
        if ip13:
            if is_internet5:
                text_body = ("connected to " + ssidName + " (" + ip13 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip14, is_internet14 = get_ip_address_ios(request, ssidName, key14, setup_perfectoMobile_android, connData)
        #
        if ip14:
            if is_internet14:
                text_body = ("connected to " + ssidName + " (" + ip14 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip15, is_internet15 = get_ip_address_ios(request, ssidName, key15, setup_perfectoMobile_android, connData)
        #
        if ip15:
            if is_internet15:
                text_body = ("connected to " + ssidName + " (" + ip15 + ") " + "with internet")
            ...
            assert False
        time.sleep(5)
        ip16, is_internet16 = get_ip_address_ios(request, ssidName, key16, setup_perfectoMobile_android, connData)
        #
        if ip16:
            if is_internet16:
                text_body = ("connected to " + ssidName + " (" + ip16 + ") " + "with internet")
