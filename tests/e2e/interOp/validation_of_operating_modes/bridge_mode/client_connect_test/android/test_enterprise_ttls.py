...
class TestBridgeModeEnterpriseTTLSSuiteA(object):
    ...
    def test_ClientConnect_5g_WPA_enterprise(self, request, get_vif_state, get_ToggleAirplaneMode_data,
                                              setup_perfectoMobile_android, radius_info, get_ap_logs):
    ...
    @pytest.mark.twog
    @pytest.mark.wpa_enterprise
    def test_ClientConnect_2g_WPA_enterprise(self, request, get_vif_state, get_ToggleAirplaneMode_data,
                                              setup_perfectoMobile_android, radius_info, get_ap_logs):
