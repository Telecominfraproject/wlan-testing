...
setup_params_general = {
    ...
    "ssid_modes": {
        ...
        "wpa": [{"ssid_name": "captive_wpa", "appliedRadios": ["2G"], "security_key": "lanforge"},
                {"ssid_name": "captive_wpa", "appliedRadios": ["5G"],
                 "security_key": "lanforge"}],
        "wpa2_personal": [
            {"ssid_name": "captive_wpa2", "appliedRadios": ["2G"], "security_key": "lanforge"},
            {"ssid_name": "captive_wpa2", "appliedRadios": ["5G"],
             "security_key": "lanforge"}]},
    "rf": {},
    "radius": False
}
