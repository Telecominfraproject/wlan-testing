...
pytestmark = [pytest.mark.interop, pytest.mark.android, pytest.mark.interop_and, pytest.mark.interop_country_codeSG1
              , pytest.mark.bridge]
...
class TestBridgeModeConnectSuiteOne(object):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7597", name="WIFI-7597")
    @pytest.mark.fiveg
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7603", name="WIFI-7603")
    @pytest.mark.twog
    @pytest.mark.wpa2_personal
    @pytest.mark.twentyMhz
