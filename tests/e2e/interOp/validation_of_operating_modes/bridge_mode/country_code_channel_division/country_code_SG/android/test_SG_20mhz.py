...
class TestBridgeModeConnectSuiteOne(object):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7739", name="WIFI-7739")
    @pytest.mark.fiveg
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7730", name="WIFI-7730")
    @pytest.mark.twog
    @pytest.mark.wpa2_personal
    @pytest.mark.twentyMhz
