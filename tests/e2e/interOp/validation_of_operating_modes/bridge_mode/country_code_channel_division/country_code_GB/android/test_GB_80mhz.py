...
class TestBridgeModeConnectSuiteOne(object):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7314", name="WIFI-7314")
    @pytest.mark.fiveg
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-7640", name="WIFI-7640")
    @pytest.mark.twog
    @pytest.mark.wpa2_personal
    @pytest.mark.eightyMhz
