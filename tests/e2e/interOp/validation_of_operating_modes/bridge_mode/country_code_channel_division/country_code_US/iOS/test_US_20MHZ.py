...
pytestmark = [pytest.mark.interop, pytest.mark.ios, pytest.mark.interop_and, pytest.mark.interop_country_code4
...
class TestBridgeModeConnectSuiteOne(object):
    ...
    def test_ClientConnect_bridge_wpa2_chn36_20Mhz_US_5g(self, request, get_vif_state, get_ap_logs,
        ...
        # Set Wifi/AP Mode
        ip, is_internet = get_ip_address_and(request, ssidName, ssidPassword, setup_perfectoMobile_iOS, connData)
