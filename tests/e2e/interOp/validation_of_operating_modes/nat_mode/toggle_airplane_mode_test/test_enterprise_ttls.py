...
pytestmark = [pytest.mark.toggle_airplane_tests, pytest.mark.nat, pytest.mark.enterprise]
...
class TestNatModeToggleAirplaneEnterpriseTTLSSuiteOne(object):
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa enterprise encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_nat_wpa_enterprise_2g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa enterprise encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_nat_wpa_enterprise_5g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
                                                      get_test_device_logs, num_stations, setup_configuration,
                                                      radius_info):
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa2 enterprise encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_nat_wpa2_enterprise_2g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa2 enterprise encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_nat_wpa2_enterprise_5g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
                                                       get_test_device_logs, num_stations, setup_configuration,
                                                       radius_info):
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa3 enterprise encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_nat_wpa3_enterprise_2g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
                                                         get_test_device_logs, num_stations, setup_configuration, radius_info):
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa3 enterprise encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_nat_wpa3_enterprise_5g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
                                                       get_test_device_logs, num_stations, setup_configuration,
                                                       radius_info):
...
for sec_modes in setup_params_enterprise_two_nat['ssid_modes'].keys():
    for i in range(len(setup_params_enterprise_two_nat['ssid_modes'][sec_modes])):
        ...
        rand_string = (''.join(random.choices(string.ascii_uppercase +
                                     string.digits, k=N)))+str(int(time.time_ns())%10000)
        setup_params_enterprise_two_nat['ssid_modes'][sec_modes][i]['ssid_name'] = setup_params_enterprise_two_nat['ssid_modes'][sec_modes][i]['ssid_name'] + "_"+ rand_string
...
class TestNatModeEnterpriseTTLSSuiteTwo(object):
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa_wpa2_enterprise_mixed encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-4565", name="JIRA LINK")
    def test_nat_wpa_wpa2_enterprise_mixed_2g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
                                                         get_test_device_logs, num_stations, setup_configuration, radius_info):
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa_wpa2_enterprise_mixed encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_nat_wpa_wpa2_enterprise_mixed_5g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
                                                         get_test_device_logs, num_stations, setup_configuration, radius_info):
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa3_enterprise_mixed encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_nat_wpa3_enterprise_mixed_2g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
                                                         get_test_device_logs, num_stations, setup_configuration, radius_info):
    ...
    @allure.title("NAT Mode Toggle Airplane Test with wpa3_enterprise_mixed encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_nat_wpa3_enterprise_mixed_5g_toggle_airplane(self, get_test_library, get_dut_logs_per_test_case,
                                                         get_test_device_logs, num_stations, setup_configuration, radius_info):
