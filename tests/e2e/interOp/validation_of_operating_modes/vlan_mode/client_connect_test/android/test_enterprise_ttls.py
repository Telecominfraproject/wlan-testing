...
class TestVlanModeEnterpriseTTLSSuiteA(object):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-4845", name="WIFI-4845")
    @pytest.mark.fiveg
    @pytest.mark.wpa2_enterprise
    def test_ClientConnect_5g_WPA2_enterprise_Vlan(self, request, get_vif_state, get_ToggleAirplaneMode_data
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-4841", name="WIFI-4841")
    @pytest.mark.twog
    @pytest.mark.wpa2_enterprise
    def test_ClientConnect_2g_WPA2_enterprise_Vlan(self, request, get_vif_state, get_ToggleAirplaneMode_data,
                                              setup_perfectoMobile_android, radius_info, get_ap_logs):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-4847", name="WIFI-4847")
    @pytest.mark.fiveg
    @pytest.mark.wpa3_enterprise
    def test_ClientConnect_5g_WPA3_enterprise_Vlan(self, request, get_vif_state, get_ToggleAirplaneMode_data,
                                              setup_perfectoMobile_android, radius_info, get_ap_logs):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-4846", name="WIFI-4846")
    @pytest.mark.twog
    @pytest.mark.wpa3_enterprise
    def test_ClientConnect_2g_WPA3_enterprise_Vlan(self, request, get_vif_state, get_ToggleAirplaneMode_data,
                                              setup_perfectoMobile_android, radius_info, get_ap_logs):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-4850", name="WIFI-4850")
    @pytest.mark.fiveg
    @pytest.mark.wpa_enterprise
    def test_ClientConnect_5g_WPA_enterprise_Vlan(self, request, get_vif_state, get_ToggleAirplaneMode_data,
                                              setup_perfectoMobile_android, radius_info, get_ap_logs):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-4849", name="WIFI-4849")
    @pytest.mark.twog
    @pytest.mark.wpa_enterprise
    def test_ClientConnect_2g_WPA_enterprise_Vlan(self, request, get_vif_state, get_ToggleAirplaneMode_data,
                                              setup_perfectoMobile_android, radius_info, get_ap_logs):
