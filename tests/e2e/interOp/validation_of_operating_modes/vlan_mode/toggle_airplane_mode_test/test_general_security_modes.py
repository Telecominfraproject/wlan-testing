...
pytestmark = [pytest.mark.toggle_airplane_tests, pytest.mark.vlan, pytest.mark.general]
...
class TestVlanModeToggleAirplaneSuiteOne(object):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with open encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_open_2g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
        ...
        band = "twog"
        vlan = [100]
        passes, result = get_test_library.toggle_airplane_mode_test(ssid=ssid_name, security=security,
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with open encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_open_5g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                            num_stations, setup_configuration, get_test_library):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa_2g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                           num_stations, setup_configuration, get_test_library):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa_5g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                           num_stations, setup_configuration, get_test_library):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa2 encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa2_personal_2g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                                     num_stations, setup_configuration, get_test_library):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa2 encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa2_personal_5g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                           num_stations, setup_configuration, get_test_library):
...
for sec_modes in setup_params_general_two_vlan['ssid_modes'].keys():
    for i in range(len(setup_params_general_two_vlan['ssid_modes'][sec_modes])):
        ...
        rand_string = (''.join(random.choices(string.ascii_uppercase +
                                     string.digits, k=N)))+str(int(time.time_ns())%10000)
        setup_params_general_two_vlan['ssid_modes'][sec_modes][i]['ssid_name'] = setup_params_general_two_vlan['ssid_modes'][sec_modes][i]['ssid_name'] + "_"+ rand_string
...
@pytest.mark.usefixtures("setup_configuration")
class TestVlanModeToggleAirplaneSuiteTwo(object):
    """ Client Connect SuiteA
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa_wpa2_personal_mixed encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa_wpa2_personal_mixed_2g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                                        num_stations, setup_configuration, get_test_library):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa_wpa2_personal_mixed encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa_wpa2_personal_mixed_5g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                                               num_stations, setup_configuration, get_test_library):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa3_personal encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa3_personal_2g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                                     num_stations, setup_configuration, get_test_library):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa3_personal encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa3_personal_5g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                           num_stations, setup_configuration, get_test_library):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa3_personal_mixed encryption 2.4 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa3_personal_mixed_2g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                                           num_stations, setup_configuration, get_test_library):
    ...
    @allure.title("VLAN Mode Toggle Airplane Test with wpa3_personal_mixed encryption 5 GHz Band")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-11102", name="JIRA LINK")
    def test_vlan_wpa3_personal_mixed_5g_toggle_airplane(self, get_dut_logs_per_test_case, get_test_device_logs,
                                           num_stations, setup_configuration, get_test_library):
