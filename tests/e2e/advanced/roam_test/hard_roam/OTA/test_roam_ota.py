...
class TestRoamOTA(object):
    ...
    def test_singleclient_single_iteration_hard_roam_5g_to_5g_ft_psk_wpa2(self, get_configuration, lf_test, lf_reports, lf_tools,
    ...
    @pytest.mark.wpa2_personal
    @pytest.mark.wpa3_personal
    def test_singleclient_multi_iteration_hard_roam_5g_to_5g_ft_psk_wpa2(self, get_configuration, lf_test, lf_reports,
                                                                          lf_tools,
                                                                          run_lf, add_env_properties,
