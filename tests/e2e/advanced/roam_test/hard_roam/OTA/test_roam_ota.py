...
class TestRoamOTA(object):
    ...
    @pytest.mark.hard_roam_5g_ota_single_client_iteration
    @pytest.mark.all_5g_ota
    @pytest.mark.wpa2_personal
    @pytest.mark.wpa3_personal
    def test_singleclient_single_iteration_hard_roam_5g_to_5g_ft_psk_wpa2(self, logger_start, get_configuration, lf_test, lf_reports, lf_tools,
    ...
    @pytest.mark.wpa2_personal
    @pytest.mark.wpa3_personal
    def test_singleclient_multi_iteration_hard_roam_5g_to_5g_ft_psk_wpa2(self,logger_start, get_configuration, lf_test, lf_reports,
                                                                          lf_tools,
                                                                          run_lf, add_env_properties,
    ...
    def test_single_client_multi_iteration__hard_roam_2g_to_2g_ft_psk_wpa2(self, get_configuration, lf_test, lf_reports, lf_tools,
                                                  ...
                                                  instantiate_profile, get_controller_logs, get_ap_config_slots,
                                                  get_lf_logs,
                                                  roaming_delay, iteration, duration, roam_debug):
        instantiate_profile_obj = instantiate_profile(controller_data=get_configuration['controller'],
                                                      timeout="10",
                                                      ap_data=get_configuration['access_point'],
                                                      type=0)
    ...
    def test_multi_client_single_iteration_hard_roam_2g_to_2g_ft_psk_wpa2(self, get_configuration, lf_test, lf_reports, lf_tools,
                                                  ...
                                                  instantiate_profile, get_controller_logs, get_ap_config_slots,
                                                  get_lf_logs,
                                                  roaming_delay,  client, duration, roam_debug):
        instantiate_profile_obj = instantiate_profile(controller_data=get_configuration['controller'],
                                                      timeout="10",
                                                      ap_data=get_configuration['access_point'],
                                                      type=0)
