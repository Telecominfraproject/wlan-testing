...
class TestRoamOTA(object):
    ...
    @pytest.mark.wpa2_personal
    @pytest.mark.wpa3_personal
    def test_multi_soft_roam_5g_to_5g_ft_psk_wpa2(self, get_configuration, lf_test, lf_reports, lf_tools,
                                                  run_lf, add_env_properties,
                                                  instantiate_profile, get_controller_logs, get_ap_config_slots,
                                                  get_lf_logs,
                                                  roaming_delay, iteration, client, duration, roam_debug):
    ...
    @pytest.mark.soft_roam_2g_ota
    @pytest.mark.wpa2_personal
    @pytest.mark.wpa3_personal
    def test_multi_soft_roam_2g_to_2g_ft_psk_wpa2(self, get_configuration, lf_test, lf_reports, lf_tools,
                                                  run_lf, add_env_properties,
                                                  instantiate_profile, get_controller_logs, get_ap_config_slots,
                                                  get_lf_logs,
                                                  roaming_delay, iteration, client, duration, roam_debug):
    ...
    @pytest.mark.soft_roam_6g_to_6g_dot1x_sha256
    @pytest.mark.wpa2_personal
    @pytest.mark.wpa3_personal
    def test_multi_soft_roam_6g_to_6g_802dot1x_sha256_wpa3(self, get_configuration, lf_test, lf_reports, lf_tools,
                                                           run_lf, add_env_properties,
                                                           instantiate_profile, get_controller_logs,
                                                           get_ap_config_slots,
                                                           get_lf_logs,
