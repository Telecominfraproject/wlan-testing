...
class TestRoamOTD(object):
    ...
    @pytest.mark.roam
    @pytest.mark.otd
    def test_roam_2g_to_2g_wpa3_psk_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed):
        """
            Test Roaming between two APs, Same channel, 2G, WPA3 Personal
            pytest -m "roam and twog and same_channel and wpa3_personal and otd"
        """
        ap_data = dict()
        dut_list = [str(selected_testbed)]
        dut_names = list()
    ...
    @pytest.mark.roam
    @pytest.mark.otd
    def test_roam_5g_to_5g_wpa3_psk_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed):
        """
            Test Roaming between two APs, Same channel, 5G, WPA3 Personal
            pytest -m "roam and fiveg and same_channel and wpa3_personal and otd"
        """
        ap_data = dict()
        dut_list = [str(selected_testbed)]
        dut_names = list()
    ...
    @pytest.mark.wpa3_personal
    @pytest.mark.same_channel
    def test_roam_6g_to_6g_wpa3psk_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed):
        """
            Test Roaming between two APs, Same channel, 6G, WPA3 Personal
            pytest -m "roam and sixg and same_channel and wpa3_personal and otd"
        """
        ap_data = dict()
        dut_list = [str(selected_testbed)]
        dut_names = list()
        ...
        try:
            pass_fail, message = get_test_library.roam_test(ap1_bssid=bssid_list[0], ap2_bssid=bssid_list[1],
                                                            ...
                                                            ssid=ssid, upstream="1.1.eth1", duration=None,
                                                            iteration=1, channel="161", option="otd", dut_name=dut_names,
                                                            traffic_type="lf_udp", sta_type="11r")
        except Exception as e:
            logging.error(f"Exception in roam test : {e}")
            pass_fail, message = False, e
    ...
    def test_roam_2g_to_2g_wpa2eap_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed, radius_info):
        """
            ...
            pytest -m "roam and twog and same_channel and wpa2_enterprise and otd"
        """
        ap_data = dict()
        dut_list = [str(selected_testbed)]
        dut_names = list()
    ...
    def test_roam_5g_to_5g_wpa2eap_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed, radius_info):
        """
            ...
            pytest -m "roam and fiveg and same_channel and wpa2_enterprise and otd"
        """
        ap_data = dict()
        dut_list = [str(selected_testbed)]
        dut_names = list()
    ...
    def test_roam_2g_to_2g_wpa3eap_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed, radius_info):
        """
            ...
            pytest -m "roam and twog and same_channel and wpa3_enterprise and otd"
        """
        ap_data = dict()
        dut_list = [str(selected_testbed)]
        dut_names = list()
    ...
    def test_roam_5g_to_5g_wpa3eap_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed, radius_info):
        """
            ...
            pytest -m "roam and fiveg and same_channel and wpa3_enterprise and otd"
        """
        ap_data = dict()
        dut_list = [str(selected_testbed)]
        dut_names = list()
    ...
    @pytest.mark.wpa3_enterprise
    @pytest.mark.same_channel
    def test_roam_6g_to_6g_wpa3eap_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed):
        """
            Test Roaming between two APs, Same channel, 6G, WPA3 Enterprise
            pytest -m "roam and sixg and same_channel and wpa3_enterprise and otd"
        """
        ap_data = dict()
        dut_list = [str(selected_testbed)]
        dut_names = list()
