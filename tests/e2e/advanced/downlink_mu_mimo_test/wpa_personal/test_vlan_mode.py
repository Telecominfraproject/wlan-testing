...
class TestMuMimoNat(object):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-10210", name="WIFI-10210")
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-10212", name="WIFI-10212")
    @pytest.mark.wpa_personal
    @pytest.mark.twog
