...
class TestMuMimoBridge(object):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-6849", name="WIFI-6849")
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-10085", name="WIFI-10085")
    @pytest.mark.wpa2_personal
    @pytest.mark.twog
