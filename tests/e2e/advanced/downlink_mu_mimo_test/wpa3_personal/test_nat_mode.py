...
class TestMuMimoNat(object):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-10205", name="WIFI-10205")
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-10207", name="WIFI-10207")
    @pytest.mark.wpa3_personal
    @pytest.mark.twog
