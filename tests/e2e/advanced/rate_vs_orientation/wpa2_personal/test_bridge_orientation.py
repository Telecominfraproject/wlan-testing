...
class TestRatevsOrientationBridge(object):
    ...
    def test_client_tcp_dl_nss2_wpa2_personal_5g(self, lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
    ...
    @pytest.mark.twog
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-5431", name="WIFI-5431")
    def test_client_tcp_dl_nss2_wpa2_personal_2g(self, lf_test, station_names_twog, create_lanforge_chamberview_dut,
                                                 get_configuration, lf_tools):
