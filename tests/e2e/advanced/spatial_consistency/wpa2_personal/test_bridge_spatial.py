...
class Test_SpatialConsistency_Bridge(object):
    ...
    @pytest.mark.twog
    @pytest.mark.nss1
    def test_dl_udp_nss1_wpa2_personal_2g(self, lf_tools, lf_test, station_names_twog,
        ...
        if station:
            rvr_o = lf_test.ratevsrange(station_name=station_names_twog, mode=mode, download_rate="100%",
                                        instance_name="SPATIAL_NSS1_RVR1", duration="60000",
    ...
    @pytest.mark.twog
    @pytest.mark.nss2
    def test_dl_udp_nss2_wpa2_personal_2g(self, lf_tools, lf_test, station_names_twog,
                                                create_lanforge_chamberview_dut, get_configuration):
        lf_tools.reset_scenario()
        profile_data = setup_params_general["ssid_modes"]["wpa2_personal"][0]
        ssid_name = profile_data["ssid_name"]
    ...
    @pytest.mark.fiveg
    @pytest.mark.nss2
    def test_dl_udp_nss2_wpa2_personal_5g(self, lf_tools, lf_test, station_names_fiveg,
                                                create_lanforge_chamberview_dut, get_configuration):
        lf_tools.reset_scenario()
        profile_data = setup_params_general["ssid_modes"]["wpa2_personal"][1]
        ssid_name = profile_data["ssid_name"]
