...
class TestRxSensitivityVLAN5G(object):
    ...
    @pytest.mark.mcs0
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs0_nss1_5g(self,
    ...
    @pytest.mark.mcs1
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs1_nss1_5g(self,
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs2
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs2_nss1_5g(self,
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs3
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs3_nss1_5g(self,
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs4
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs4_nss1_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs5
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs5_nss1_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs6
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs6_nss1_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs7
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs7_nss1_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs8
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs8_nss1_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs9
    @pytest.mark.nss1
    def test_client_wpa2_personal_vlan_mcs9_nss1_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs0
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs0_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs1
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs1_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs2
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs2_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs3
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs3_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs4
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs4_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs5
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs5_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs6
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs6_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs7
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs7_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs8
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs8_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs9
    @pytest.mark.nss2
    def test_client_wpa2_personal_vlan_mcs9_nss2_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs0
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs0_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs1
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs1_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs2
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs2_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs3
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs3_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs4
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs4_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs5
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs5_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs6
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs6_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs7
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs7_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs8
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs8_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs9
    @pytest.mark.nss3
    def test_client_wpa2_personal_vlan_mcs9_nss3_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs0
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs0_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs1
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs1_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs2
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs2_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs3
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs3_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs4
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs4_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs5
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs5_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs6
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs6_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs7
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs7_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs8
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs8_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
    ...
    @pytest.mark.mcs9
    @pytest.mark.nss4
    def test_client_wpa2_personal_vlan_mcs9_nss4_5g(self, 
                                               lf_test, station_names_fiveg, create_lanforge_chamberview_dut,
                                               get_configuration):
        """Receiver Sensitivity vlan Mode
           pytest -m "rx_sensitivity_test and vlan and wpa2_personal and fiveg"
