...
class TestBridgeModeadvancedcaptiveportal(object):
    ...
    def test_bridge_wpa2_2g_local_user_and_pass(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            ...
            Local user/pass mode (Captive-Credentials): In this mode the client needs to enter the valid credentials
            that are configured in the AP to get the internet access.

            Unique Marker:
            advanced_captive_portal_tests and wpa2_personal and twog and bridge and local_user_and_pass
        """
