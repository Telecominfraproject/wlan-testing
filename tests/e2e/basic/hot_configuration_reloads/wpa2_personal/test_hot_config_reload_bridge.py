...
class TestHotReloadConfigSuite(object):
    ...
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-14185", name="WIFI-14185")
    def test_hot_config_reload_tx_power(self, get_test_library, get_test_device_logs,
                                        ...
                                        client_type):
        """
            Test Description: The hot reload config feature allows real-time configuration updates without restarting services, minimizing downtime and service disruptions. It’s essential for maintaining continuous operation, especially in critical systems or environments with frequent updates. This feature enhances flexibility, improves scalability, and reduces the risk of human error. Here Tx-Power parameter comes under radio (PHY level) of AP, hence it’s modification should restart the service
    ...
    @pytest.mark.he
    @allure.story('wpa2_personal 5 GHZ Band')
    @allure.title("BRIDGE Mode Hot Reload with wpa2_personal encryption 5 GHz Band(HE Parameter - bss color)")
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-14200", name="WIFI-14200")
    def test_hot_config_reload_he(self, get_test_library, get_test_device_logs,
                                   get_testbed_details,
                                   get_dut_logs_per_test_case, get_target_object,
                                   num_stations, check_connectivity, setup_configuration,
                                   client_type):
        """
            Test Description: The hot reload config feature allows real-time configuration updates without restarting services, minimizing downtime and service disruptions. It’s essential for maintaining continuous operation, especially in critical systems or environments with frequent updates. This feature enhances flexibility, improves scalability, and reduces the risk of human error. Here HE bss-color feature comes under radio (PHY level) of AP, hence it’s modification should restart the service

            Marker:
            hot_reload and bridge and general and wpa2_personal and fiveg and he
        """
