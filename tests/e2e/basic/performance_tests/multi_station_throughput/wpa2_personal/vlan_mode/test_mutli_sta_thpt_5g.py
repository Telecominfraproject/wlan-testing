...
class TestMultiStaThptvlan(object):
    ...
    def test_mstathpt_wpa2p_vlan_udp_dl_5g_1(self,  lf_tools,
    ...
    def test_mstathpt_wpa2p_vlan_tcp_dl_5g_2(self,  lf_tools,
                                             create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal  and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_ul_5g_3(self,  lf_tools,
                                             create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_ul_5g_4(self,  lf_tools,
                                             create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_dl_5g_5(self,  lf_tools,
                                             create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_dl_5g_6(self,  lf_tools,
                                             create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_ul_5g_7(self,  lf_tools,
                                             create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_ul_5g_8(self,  lf_tools,
                                             create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_dl_5g_9(self,  lf_tools,
                                             create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_dl_5g_10(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_ul_5g_11(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_ul_5g_12(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_dl_5g_13(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_dl_5g_14(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_ul_5g_15(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_ul_5g_16(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_ul_5g_17(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_dl_5g_18(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_ul_5g_19(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_ul_5g_20(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_dl_5g_21(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_dl_5g_22(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_udp_ul_5g_23(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
    ...
    def test_mstathpt_wpa2p_vlan_tcp_ul_5g_24(self,  lf_tools,
                                              create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "multi_sta_thpt and vlan and wpa2_personal and fiveg"
