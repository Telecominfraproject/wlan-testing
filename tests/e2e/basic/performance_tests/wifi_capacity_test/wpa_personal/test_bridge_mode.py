...
class TestWifiCapacityBRIDGEModeDualBand(object):
    ...
    def test_client_wpa_bridge_tcp_dl(self, lf_tools, setup_configuration,
    ...
    def test_client_wpa_bridge_udp_dl(self,  lf_tools,
                                      lf_test, station_names_twog, create_lanforge_chamberview_dut,
                                      get_configuration):
        """ Wifi Capacity Test BRIDGE mode
            pytest -m "wifi_capacity_test and bridge and wpa_personal and twog"
    ...
    def test_client_wpa_bridge_tcp_bidirectional(self,  lf_tools,
                                                 lf_test, station_names_twog, create_lanforge_chamberview_dut,
                                                 get_configuration):
        """ Wifi Capacity Test BRIDGE mode
            pytest -m "wifi_capacity_test and bridge and wpa_personal and twog"
    ...
    def test_client_wpa_bridge_udp_bidirectional(self,  lf_tools,
                                                 lf_test, station_names_twog, create_lanforge_chamberview_dut,
                                                 get_configuration):
        """ Wifi Capacity Test BRIDGE mode
            pytest -m "wifi_capacity_test and bridge and wpa_personal and twog"
