...
pytestmark = [pytest.mark.performance, pytest.mark.nat,pytest.mark.wifi_capacity_test]
...
class TestWifiCapacityNATModeDualBand(object):
    ...
    def test_client_wpa2_NAT_udp_dl(self, lf_tools, get_apnos_max_clients,
        ...
        wct_obj = lf_test.wifi_capacity(instance_name="test_client_wpa2_NAT_udp_dl", mode=mode, vlan_id=vlan,
                                        download_rate="1Gbps", batch_size="1,5,10,20,40,64,128,256",
                                        influx_tags=influx_tags, sets=sets,
                                        upload_rate="100Mbps", protocol="UDP-IPv4", duration="60000", move_to_influx=False)
    ...
    @pytest.mark.wifi_capacity_tcp_ul
    ...
    @pytest.mark.wifi_capacity_udp_ul
