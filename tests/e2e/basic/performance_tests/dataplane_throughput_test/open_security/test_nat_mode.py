"""
    ...
    pytest -m "dataplane_tests open security and nat"
...
class TestDataplaneThroughputNAT(object):
    """Dataplane THroughput NAT Mode
       pytest -m "dataplane_tests and open and nat"
    """
    ...
    def test_tcp_upd_open_nat_2g_band(self, get_test_library, get_dut_logs_per_test_case,
        ...
        in the NAT mode scenario with Open security.

        Unique Marker:
        dataplane_tests and nat and open and twog
    ...
    def test_tcp_upd_open_nat_5g_band(self, get_test_library, get_dut_logs_per_test_case,
        ...
        Unique Marker:
        dataplane_tests and nat and open and fiveg
