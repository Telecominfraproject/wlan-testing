...
pytestmark = [pytest.mark.vlan, pytest.mark.dataplane_throughput_test, pytest.mark.wpa]
...
@allure.feature("VLAN MODE wpa security and Dataplane Throughput Test")
...
class TestDataplaneThroughputVLAN(object):
    """Dataplane THroughput VLAN Mode
       pytest -m "dataplane_throughput_test and wpa and VLAN"
    """
    ...
    def test_tcp_upd_wpa_vlan_2g_band(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """Dataplane THroughput VLAN Mode
           pytest -m "dataplane_throughput_test and VLAN and wpa and twog"
        """
    ...
    def test_tcp_upd_wpa_vlan_5g_band(self, get_test_library, get_dut_logs_per_test_case,
                                      ...
                                      num_stations, setup_configuration):
        """Dataplane THroughput VLAN Mode
           pytest -m "dataplane_throughput_test and VLAN and wpa and fiveg"
        """
