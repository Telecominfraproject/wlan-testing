...
setup_params_general = {
    ...
    "ssid_modes": {
        "wpa2_personal": [
            {"ssid_name": "wpa2_personal_dataplane_2g", "appliedRadios": ["2G"], "security_key": "something", "vlan": 100},
            {"ssid_name": "wpa2_personal_dataplane_5g", "appliedRadios": ["5G"], "security_key": "something", "vlan": 100}]},
    "rf": {},
    "radius": False
}
...
class TestDataplaneThroughputVLAN(object):
    ...
    def test_tcp_upd_wpa2_personal_vlan_2g_band(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
        profile_data = {"ssid_name": "ssid_wpa2_personal_2g", "appliedRadios": ["2G"], "security_key": "something", "vlan": 100}
    ...
    def test_tcp_upd_wpa2_personal_vlan_5g_band(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
        profile_data = {"ssid_name": "ssid_wpa2_personal_5g", "appliedRadios": ["5G"], "security_key": "something", "vlan": 100}
        ssid_name = profile_data["ssid_name"]
        security = "wpa2_personal"
        mode = "VLAN"
        band = "fiveg"
