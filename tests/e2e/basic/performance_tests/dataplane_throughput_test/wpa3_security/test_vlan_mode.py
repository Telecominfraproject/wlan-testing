...
pytestmark = [pytest.mark.vlan, pytest.mark.dataplane_throughput_test, pytest.mark.wpa3_personal]
...
@allure.feature("VLAN MODE wpa3_personal security and Dataplane Throughput Test")
