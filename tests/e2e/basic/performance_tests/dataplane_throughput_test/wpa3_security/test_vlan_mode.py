...
pytestmark = [pytest.mark.vlan, pytest.mark.dataplane_tests, pytest.mark.wpa3_personal]
...
class TestDataplaneThroughputVLAN(object):
    ...
    def test_tcp_udp_wpa3_personal_vlan_2g_band(self, get_test_library, get_dut_logs_per_test_case,
        ...
        in the VLAN mode scenario with WPA3-Personal security.

        Unique Marker:
        dataplane_tests and vlan and wpa3_personal and twog
    ...
    def test_tcp_udp_wpa3_personal_vlan_5g_band(self, get_test_library, get_dut_logs_per_test_case,
        ...
        Unique Marker:
        dataplane_tests and vlan and wpa3_personal and fiveg
    ...
    def test_tcp_udp_wpa3_personal_vlan_6g_band(self, get_test_library, get_dut_logs_per_test_case,
        ...
        Unique Marker:
        dataplane_tests and vlan and wpa3_personal and sixg
