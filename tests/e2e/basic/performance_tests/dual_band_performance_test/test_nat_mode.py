"""
       ...
       pytest -m "dual_band_performance_test and nat"
...
pytestmark = [pytest.mark.dual_band_performance_test, pytest.mark.nat,
...
class TestDualbandPerformanceNat(object):
    """
        pytest -m "dual_band_performance_test and nat and open and twog  and fiveg"
    """
    ...
    """
       pytest -m "dual_band_performance_test and nat and wpa and twog  and fiveg"
    """
    @pytest.mark.wpa
    @pytest.mark.twog
    @pytest.mark.fiveg
    def test_client_wpa(self, get_vif_state,create_lanforge_chamberview_dut, lf_test,get_configuration):
        ...
        dbpt_obj = lf_test.dualbandperformancetest(mode=mode, ssid_2G=ssid_2G, ssid_5G=ssid_5G,
                                                   instance_name="dbp_instance_wpa_nat",
                                                   vlan_id=vlan, dut_name=dut_name)
        report_name = dbpt_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
        entries = os.listdir("../reports/" + report_name + '/')
        pdf = False
    ...
    """
         pytest -m "dual_band_performance_test and nat and wpa2_personal and twog  and fiveg"
    """
