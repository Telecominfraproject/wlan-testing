...
setup_params_general2 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_40", "appliedRadios": ["5G"], "security_key": "something"}
                          ]},
    "rf": {
        "5G": {
            'band': '5G',
...
class Test20Mhz5GChannel40PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_40", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general3 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_44", "appliedRadios": ["5G"], "security_key": "something"}]},
    "rf": {
        "5G": {
            'band': '5G',
            'channel-width': 20,
...
class Test20Mhz5GChannel44PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_44", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general4 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_48", "appliedRadios": ["5G"], "security_key": "something"}]},
    "rf": {
        "5G": {
            'band': '5G',
...
class TestCountryCA20Mhz5GChannel48PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_48", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general6 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_56", "appliedRadios": ["5G"], "security_key": "something"}]},
    "rf": {
        "5G": {
            'band': '5G',
...
class TestCountryCA20Mhz5GChannel56PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_56", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general7 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_60", "appliedRadios": ["5G"], "security_key": "something"}]},
    "rf": {
        "5G": {
            'band': '5G',
...
class TestCountryCA20Mhz5GChannel60PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
                                       get_test_device_logs, num_stations, setup_configuration):
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and fiveg"
        """
        profile_data = {"ssid_name": "ssid_open_5g_60", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general8 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_64", "appliedRadios": ["5G"], "security_key": "something"}
                          ]},
    "rf": {
        "5G": {
            'band': '5G',
...
class TestCountryCA20Mhz5GChannel64PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_64", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general10 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_104", "appliedRadios": ["5G"], "security_key": "something"}]},
    "rf": {
        "5G": {
            'band': '5G',
...
class TestCountryCA20Mhz5GChannel104PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_104", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general11 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_108", "appliedRadios": ["5G"], "security_key": "something"}]},
    "rf": {
        "5G": {
            'band': '5G',
...
class TestCountryCA20Mhz5GChannel108PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_108", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general12 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_112", "appliedRadios": ["5G"], "security_key": "something"}
                          ]},
    "rf": {
        "5G": {
            'band': '5G',
...
class TestCountryCA20Mhz5GChannel112PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_112", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general13 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_116", "appliedRadios": ["5G"], "security_key": "something"}
                          ]},
    "rf": {
        "5G": {
            'band': '5G',
...
class TestCountryCA20Mhz5GChannel116PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_116", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general15 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_136", "appliedRadios": ["5G"], "security_key": "something"}]},
    "rf": {
        "5G": {
            'band': '5G',
            'channel-width': 20,
...
class TestCountryCA20Mhz5GChannel136PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_136", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general16 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_140", "appliedRadios": ["5G"], "security_key": "something"}
                          ]},
    "rf": {
        "5G": {
            'band': '5G',
...
class TestCountryCA20Mhz5GChannel140PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_140", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general17 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_5g_144", "appliedRadios": ["5G"], "security_key": "something"}]},
    "rf": {
        "5G": {
            'band': '5G',
            'channel-width': 20,
...
class TestCountryCA20Mhz5GChannel144PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and nat and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_5g_144", "appliedRadios": ["5G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
