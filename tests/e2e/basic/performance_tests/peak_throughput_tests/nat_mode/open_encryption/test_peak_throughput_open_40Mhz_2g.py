...
setup_params_general_1 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_1", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
            'channel-width': 40,
...
class Test20Mhz2GChannel1PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
        profile_data = {"ssid_name": "ssid_open_2g_1", "appliedRadios": ["2G"], "security_key": "something"}
...
setup_params_general_2 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_2", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
            'channel-width': 40,
...
class Test20Mhz2GChannel2PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_2", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general_3 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_3", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
            'channel-width': 40,
...
class Test20Mhz2GChannel3PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_3", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general_4 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_4", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
            'channel-width': 40,
...
class Test20Mhz2GChannel4PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_4", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general_5 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_5", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
            'channel-width': 40,
...
class Test20Mhz2GChannel5PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_5", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general_6 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_6", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
            'channel-width': 40,
...
class Test20Mhz2GChannel6PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_6", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general_7 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_7", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
...
class Test20Mhz2GChannel7PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_7", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general_8 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_8", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
            'channel-width': 40,
...
class Test20Mhz2GChannel8PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_8", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general_9 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_9", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
...
class Test20Mhz2GChannel9PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_9", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general_10 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_10", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
            'channel-width': 40,
...
class Test20Mhz2GChannel10PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_10", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
...
setup_params_general_11 = {
    "mode": "NAT",
    "ssid_modes": {
        "open": [{"ssid_name": "ssid_open_2g_11", "appliedRadios": ["2G"], "security_key": "something"}]},
    "rf": {
        "2G": {
            'band': '2G',
            'channel-width': 40,
...
class Test20Mhz2GChannel11PeakThroughput(object):
    ...
    def test_client_open_nat_tcp_dl(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """ Wifi Capacity Test NAT mode
            pytest -m "peak_throughput_tests and NAT and open and twog"
        """
        profile_data = {"ssid_name": "ssid_open_2g_11", "appliedRadios": ["2G"], "security_key": "something"}
        ssid_name = profile_data["ssid_name"]
        mode = "NAT-WAN"
        get_test_library.wifi_capacity(instance_name="test_client_open_nat_tcp_bidirectional", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
