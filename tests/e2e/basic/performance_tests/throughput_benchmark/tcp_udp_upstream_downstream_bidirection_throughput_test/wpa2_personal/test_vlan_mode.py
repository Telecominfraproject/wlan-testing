...
pytestmark = [pytest.mark.throughput_benchmark_test, pytest.mark.vlan]

setup_params_general = {
    "mode": "VLAN",
    "ssid_modes": {
        "wpa2_personal": [
            {"ssid_name": "ssid_wpa2_2g",
             "appliedRadios": ["2G"],
             "security_key": "something",
             "vlan": 100},
            {"ssid_name": "ssid_wpa2_5g",
             "appliedRadios": ["5G"],
             "security_key": "something",
             "vlan": 100}]},
    "rf": {
...
class TestThroughputUnderCombinationsVLAN20MHz(object):
    ...
    def test_client_wpa2_personal_2g_up_nss2_udp(self, 
        ...
        if station:
            dp_obj = lf_test.dataplane(station_name=station_names_twog, mode=mode,
                                       instance_name="TIP1_PERF_DPT_WPA2_2G_VLAN",
    ...
    def test_client_wpa2_personal_5g_up_nss2_udp(self, 
        ...
        if station:
            ...
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_2g_down_nss2_udp(self, 
        ...
        if station:
            dp_obj = lf_test.dataplane(station_name=station_names_twog, mode=mode,
                                       instance_name="TIP_PERF_DPT_WPA2_2G_down_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_down_nss2_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G__down_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_2g_bi_nss2_udp(self, 
        ...
        if station:
            dp_obj = lf_test.dataplane(station_name=station_names_twog, mode=mode,
                                       instance_name="TIP_PERF_DPT_WPA2_2G_bidirectional_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_bi_nss2_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_bi_nss2_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_2g_up_nss2_tcp(self, 
        ...
        if station:
            dp_obj = lf_test.dataplane(station_name=station_names_twog, mode=mode,
                                       instance_name="TIP_PERF_DPT_WPA2_2G__up_nss2_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_up_nss2_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G__up_nss2_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_2g_down_nss2_tcp(self, 
        ...
        if station:
            dp_obj = lf_test.dataplane(station_name=station_names_twog, mode=mode,
                                       instance_name="TIP_PERF_DPT_WPA2_2G__down_nss2_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_down_nss2_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G__down_nss2_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_2g_bi_nss2_tcp(self, 
        ...
        if station:
            dp_obj = lf_test.dataplane(station_name=station_names_twog, mode=mode,
                                       instance_name="TIP_PERF_DPT_WPA2_2G__bi_nss2_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_bi_nss2_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G__bi_nss2_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
...
class TestThroughputUnderCombinationsVLAN80MHz(object):
    ...
    def test_client_wpa2_personal_5g_up_nss2_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80__up_nss2_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_down_nss2_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80__down_nss2_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_bi_nss2_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80__bi_nss2_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_up_nss2_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80_up_nss2_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_down_nss2_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80_down_nss2_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_2g_bi_nss2_tcp(self, 
        ...
        if station:
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP_PERF_DPT_WPA2_2G_80_bi_nss2_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_up_nss3_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80__up_nss3_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_down_nss3_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80__down_nss3_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_bi_nss3_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80__bi_nss3_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_up_nss3_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80__up_nss3_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_down_nss3_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80_down_nss3_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_bi_nss3_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_80_bi_nss3_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
...
class TestThroughputUnderCombinationsVLAN160MHz(object):
    ...
    def test_client_wpa2_personal_5g_up_nss3_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_up_nss3_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_down_nss3_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_down_nss3_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_bi_nss3_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_bi_nss3_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_up_nss3_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_up_nss3_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_up_nss4_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_up_nss4_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_down_nss4_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_down_nss4_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_bi_nss4_udp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_bi_nss4_udp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_up_nss4_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_up_nss4_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_down_nss4_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_down_nss4_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
    ...
    def test_client_wpa2_personal_5g_bi_nss4_tcp(self, 
        ...
        if station:
            time.sleep(3)
            dp_obj = lf_test.dataplane(station_name=station_names_fiveg, mode=mode,
                                       instance_name="TIP3_DPT_WPA2_5G_160_bi_nss4_tcp_VLAN",
                                       vlan_id=vlan, dut_name=dut_name, raw_lines=val)
            report_name = dp_obj.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            entries = os.listdir("../reports/" + report_name + '/')
            pdf = False
