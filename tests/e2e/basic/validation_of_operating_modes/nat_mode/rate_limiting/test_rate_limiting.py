...
pytestmark = [pytest.mark.ow_regression_lf,
              pytest.mark.nat, pytest.mark.ow_rate_limiting_tests_lf]
...
class TestRateLimitingNAT(object):
    ...
    def test_wpa2_personal_ssid_up_batch_size_125_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            ...
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and up and batch_size_125"
        """
        ...
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up", mode=mode,
    ...
    def test_wpa2_personal_ssid_dw_batch_size_125_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and dw and batch_size_125"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_2g_br",
                        "appliedRadios": ["2G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_dw", mode=mode,
    ...
    def test_wpa2_personal_ssid_up_dw_batch_size_125_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and up_dw and batch_size_125"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_2g_br",
                        "appliedRadios": ["2G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_dw", mode=mode,
                                       download_rate="1Gbps", batch_size="1,2,5",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"2G": 5})
    ...
    def test_wpa2_personal_ssid_disable_up_dw_batch_size_125_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and disable_up_dw"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_2g_br",
                        "appliedRadios": ["2G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_dw_di", mode=mode,
                                       download_rate="1Gbps", batch_size="1,2,5",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"2G": 5})
    ...
    def test_wpa2_personal_ssid_up_dw_per_client_batch_size_125_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and up_dw_per_client"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_2g_br",
                        "appliedRadios": ["2G"],
        ...
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_dw_per_cl", mode=mode,
                                       download_rate="1Gbps", batch_size="1,2,5",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
    ...
    def test_wpa2_personal_ssid_up_per_client_batch_size_125_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and up_per_client"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_2g_br",
                        "appliedRadios": ["2G"],
        ...
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_per_cl", mode=mode,
                                       download_rate="0Gbps", batch_size="1,2,5",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"2G": 5}, raw_lines=raw_lines)
    ...
    def test_wpa2_personal_ssid_dw_per_client_batch_size_125_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and dw_per_client"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_2g_br",
                        "appliedRadios": ["2G"],
        ...
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_dw_per_cl", mode=mode,
                                       download_rate="1Gbps", batch_size="1,2,5",
                                       upload_rate="0Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"2G": 5}, raw_lines=raw_lines)
    ...
    def test_wpa2_personal_ssid_up_batch_size_125_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and up and batch_size_125"
        """
        # run wifi capacity test here
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_125", mode=mode,
                                       download_rate="0Gbps", batch_size="1,2,5",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"5G": 5})
    ...
    def test_wpa2_personal_ssid_dw_batch_size_125_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and dw and batch_size_125"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_5g_br",
                        "appliedRadios": ["5G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_dw_125", mode=mode,
                                       download_rate="1Gbps", batch_size="1,2,5",
                                       upload_rate="0Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"5G": 5})
    ...
    def test_wpa2_personal_ssid_up_dw_batch_size_125_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and up_dw and batch_size_125"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_5g_br",
                        "appliedRadios": ["5G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_dw_125", mode=mode,
                                       download_rate="1Gbps", batch_size="1,2,5",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"5G": 5})
    ...
    def test_wpa2_personal_ssid_up_batch_size_1_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and up and batch_size_1"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_2g_br",
                        "appliedRadios": ["2G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_1", mode=mode,
    ...
    def test_wpa2_personal_ssid_dw_batch_size_1_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and dw and batch_size_1"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_2g_br",
                        "appliedRadios": ["2G"],
    ...
    def test_wpa2_personal_ssid_up_dw_batch_size_1_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and twog and up_dw and batch_size_1"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_2g_br",
                        "appliedRadios": ["2G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_tcp_dl_up_dw_1", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"2G": 1})
    ...
    def test_wpa2_personal_ssid_up_batch_size_1_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and up and batch_size_1"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_5g_br",
                        "appliedRadios": ["5G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_1_5g", mode=mode,
                                       download_rate="0Gbps", batch_size="1",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"5G": 1})
    ...
    def test_wpa2_personal_ssid_dw_batch_size_1_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and dw and batch_size_1"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_5g_br",
                        "appliedRadios": ["5G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_dw_1_5g", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
                                       upload_rate="0Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"5G": 1})
    ...
    def test_wpa2_personal_ssid_up_dw_batch_size_1_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and up_dw and batch_size_1"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_5g_br",
                        "appliedRadios": ["5G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_dw_1_5g", mode=mode,
                                       download_rate="1Gbps", batch_size="1",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"5G": 1})
    ...
    def test_wpa2_personal_ssid_disable_up_dw_batch_size_125_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and disable_up_dw"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_5g_br",
                        "appliedRadios": ["5G"],
        ...
        mode = "NAT-WAN"
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_dw_di_5g", mode=mode,
                                       download_rate="1Gbps", batch_size="1,2,5",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"5G": 5})
    ...
    def test_wpa2_personal_ssid_up_dw_per_client_batch_size_125_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and up_dw_per_client"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_5g_br",
                        "appliedRadios": ["5G"],
        ...
        raw_lines = [["dl_rate_sel: Per-Station Download Rate:"], ["ul_rate_sel: Per-Station Download Rate:"]]
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_per_cl_5g", mode=mode,
                                       download_rate="1Gbps", batch_size="1,2,5",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
    ...
    def test_wpa2_personal_ssid_up_per_client_batch_size_125_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and up_per_client"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_5g_br",
                        "appliedRadios": ["5G"],
        ...
        raw_lines = [["ul_rate_sel: Per-Station Download Rate:"]]
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_up_per_cl_5g", mode=mode,
                                       download_rate="0Gbps", batch_size="1,2,5",
                                       upload_rate="1Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"5G": 5}, raw_lines=raw_lines)
    ...
    def test_wpa2_personal_ssid_dw_per_client_batch_size_125_5g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
            Test Rate Limiting Scenario
            pytest -m "ow_rate_limiting_tests_lf and nat and wpa2_personal and fiveg and dw_per_client"
        """
        # run wifi capacity test here
        profile_data = {"ssid_name": "ssid_wpa2_5g_br",
                        "appliedRadios": ["5G"],
        ...
        raw_lines = [["dw_rate_sel: Per-Station Download Rate:"]]
        allure.attach(name="ssid-rates", body=str(profile_data["rate-limit"]))
        get_test_library.wifi_capacity(instance_name="test_client_wpa2_NAT_dw_per_cl_5g", mode=mode,
                                       download_rate="1Gbps", batch_size="1,2,5",
                                       upload_rate="0Gbps", protocol="UDP-IPv4", duration="60000",
                                       move_to_influx=False, dut_data=setup_configuration, ssid_name=ssid_name,
                                       num_stations={"5G": 5}, raw_lines=raw_lines)
