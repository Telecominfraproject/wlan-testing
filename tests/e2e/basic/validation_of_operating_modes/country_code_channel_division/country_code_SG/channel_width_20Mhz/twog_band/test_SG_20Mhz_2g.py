...
class TestCountrySG20Mhz2GChannel1(object):
    ...
    def test_client_bridge_wpa2_chn1_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel2(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn2_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel3(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn3_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel4(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn4_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel5(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn5_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel6(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn6_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel7(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn7_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel8(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn8_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel9(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn9_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel10(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn10_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel11(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn11_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel12(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn12_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz2GChannel13(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn13_20Mhz_SG_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
