...
@allure.sub_suite("SG country code (Channel-36)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel36(object):
    ...
    def test_client_bridge_wpa2_chn36_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        ...
        result = lf_test.country_code_channel_division(ssid=ssid, security=security, passkey=security_key, mode=mode,
                                                       ...
                                                       channel=channel,channel_width=channel_width,country_num=702,
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-40)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel40(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn40_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-44)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel44(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn44_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-48)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel48(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn48_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-52)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel52(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn52_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-56)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel56(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn56_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-60)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel60(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn60_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-64)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel64(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn64_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-100)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel100(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn100_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-104)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel104(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn104_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-108)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel108(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn108_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-112)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel112(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn112_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-116)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel116(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn116_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-120)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel120(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn120_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-124)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel124(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn124_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-128)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel128(object):
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn128_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-132)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel132(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn132_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-136)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel136(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn136_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-140)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel140(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn140_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-144)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel144(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn144_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
class TestCountrySG20Mhz5GChannel149(object):
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn149_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-153)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel153(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn153_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-157)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel157(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn157_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-161)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel161(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn161_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("SG country code (Channel-165)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountrySG20Mhz5GChannel165(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn165_20Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
