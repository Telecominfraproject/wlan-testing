...
class TestCountrySG80Mhz5GChannel36(object):
    ...
    def test_client_bridge_wpa2_chn36_80Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
...
class TestCountrySG80Mhz5GChannel52(object):
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn52_80Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
class TestCountrySG80Mhz5GChannel100(object):
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn100_80Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
class TestCountrySG80Mhz5GChannel116(object):
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn116_80Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
class TestCountrySG80Mhz5GChannel132(object):
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn132_80Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
...
class TestCountrySG80Mhz5GChannel149(object):
    ...
    @allure.title("Test for wpa2 encryption 5 GHz Band")
    def test_client_bridge_wpa2_chn149_80Mhz_SG_5g(self, lf_test, station_names_fiveg, get_configuration):
        """Country code Bridge Mode
