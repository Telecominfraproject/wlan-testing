...
class TestCountryRU40Mhz2GChannel1(object):
    ...
    def test_client_bridge_wpa2_chn1_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
...
class TestCountryRU40Mhz2GChannel2(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn2_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel3(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn3_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel4(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn4_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel5(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn5_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel6(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn6_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel7(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn7_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel8(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn8_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel9(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn9_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel10(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn10_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel11(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn11_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel12(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn12_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
...
class TestCountryRU40Mhz2GChannel13(object):
    ...
    @allure.title("Test for wpa2 encryption 2.4 GHz Band")
    def test_client_bridge_wpa2_chn13_40Mhz_RU_2g(self, lf_test, station_names_twog, get_configuration):
        """Country code Bridge Mode
