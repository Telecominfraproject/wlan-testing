...
class TestCountryCA20Mhz5GChannel36(object):
    ...
    def test_client_bridge_wpa2_chn36_20Mhz_CA_5g(self, get_test_library, setup_configuration):
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("CA country code (Channel-40)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountryCA20Mhz5GChannel40(object):
    ...
    def test_client_bridge_wpa2_chn40_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
class TestCountryCA20Mhz5GChannel44(object):
    ...
    def test_client_bridge_wpa2_chn44_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("CA country code (Channel-48)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountryCA20Mhz5GChannel48(object):
    ...
    def test_client_bridge_wpa2_chn48_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
class TestCountryCA20Mhz5GChannel52(object):
    ...
    def test_client_bridge_wpa2_chn52_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("CA country code (Channel-56)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountryCA20Mhz5GChannel56(object):
    ...
    def test_client_bridge_wpa2_chn56_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
class TestCountryCA20Mhz5GChannel60(object):
    ...
    def test_client_bridge_wpa2_chn60_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("CA country code (Channel-64)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountryCA20Mhz5GChannel64(object):
    ...
    def test_client_bridge_wpa2_chn64_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
class TestCountryCA20Mhz5GChannel100(object):
    ...
    def test_client_bridge_wpa2_chn100_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("CA country code (Channel-104)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountryCA20Mhz5GChannel104(object):
    ...
    def test_client_bridge_wpa2_chn104_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
class TestCountryCA20Mhz5GChannel108(object):
    ...
    def test_client_bridge_wpa2_chn108_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("CA country code (Channel-112)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountryCA20Mhz5GChannel112(object):
    ...
    def test_client_bridge_wpa2_chn112_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("CA country code (Channel-116)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountryCA20Mhz5GChannel116(object):
    ...
    def test_client_bridge_wpa2_chn116_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
class TestCountryCA20Mhz5GChannel132(object):
    ...
    def test_client_bridge_wpa2_chn132_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("CA country code (Channel-136)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountryCA20Mhz5GChannel136(object):
    ...
    def test_client_bridge_wpa2_chn136_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
class TestCountryCA20Mhz5GChannel140(object):
    ...
    def test_client_bridge_wpa2_chn140_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@allure.parent_suite("Country Code Tests")
@allure.suite("BRIDGE Mode(20 MHz)")
@allure.sub_suite("CA country code (Channel-144)")
@pytest.mark.usefixtures("setup_configuration")
class TestCountryCA20Mhz5GChannel144(object):
    ...
    def test_client_bridge_wpa2_chn144_20Mhz_CA_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
