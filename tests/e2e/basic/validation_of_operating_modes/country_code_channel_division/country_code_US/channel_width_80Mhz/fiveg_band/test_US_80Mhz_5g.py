...
class TestCountryUS80Mhz5GChannel36(object):
    ...
    def test_client_bridge_wpa2_chn36_80Mhz_US_5g(self, get_test_library, setup_configuration):
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountryUS80Mhz5GChannel52(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    def test_client_bridge_wpa2_chn52_80Mhz_US_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountryUS80Mhz5GChannel100(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    def test_client_bridge_wpa2_chn100_80Mhz_US_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
class TestCountryUS80Mhz5GChannel116(object):
    ...
    def test_client_bridge_wpa2_chn116_80Mhz_US_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountryUS80Mhz5GChannel132(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    def test_client_bridge_wpa2_chn132_80Mhz_US_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
...
@pytest.mark.usefixtures("setup_configuration")
class TestCountryUS80Mhz5GChannel149(object):
    """Country code along with Channel and Channel-width Test Bridge mode
       pytest -m "country_code and Bridge"
    """
    @allure.testcase(url="https://telecominfraproject.atlassian.net/browse/WIFI-2546", name="WIFI-6938")
    ...
    def test_client_bridge_wpa2_chn149_80Mhz_US_5g(self, get_test_library, setup_configuration):
        """Country code Bridge Mode
