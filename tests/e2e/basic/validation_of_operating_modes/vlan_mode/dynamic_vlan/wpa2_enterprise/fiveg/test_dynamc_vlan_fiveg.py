...
class TestDynamicVlan(object):
    ...
    def test_dynamic_vlan_in_the_absence_of_radius_vlan_identifier(self, get_vif_state, lf_tools,get_lf_logs,get_ap_logs,
    ...
    def test_dynamic_invalid_vlan(self, get_vif_state, lf_tools,get_lf_logs,get_ap_logs,
        ...
        print("station ip...", lf_test.station_ip[station_names_fiveg[0]])
        print("upstream port ip...", eth_vlan_ip)
    ...
    def test_dynamic_periodic_reauthentication_vlan(self, get_vif_state, lf_tools,get_lf_logs,get_ap_logs,
                                                    create_lanforge_chamberview_dut, lf_test, get_configuration,
                                                    station_names_fiveg):
        """
    ...
    def test_dynamic_absence_of_vlanid(self, get_vif_state, lf_tools,get_lf_logs,get_ap_logs,
                                       create_lanforge_chamberview_dut, lf_test, get_configuration,
                                       station_names_fiveg):
        """
    ...
    def test_dynamic_outof_bound_vlanid(self, get_vif_state, lf_tools,get_lf_logs,get_ap_logs,
                                        create_lanforge_chamberview_dut, lf_test, get_configuration,
                                        station_names_fiveg):
        """
    ...
    def test_subsequent_user_for_same_user_account_vlan(self, get_vif_state, lf_tools,get_lf_logs,
                                                        get_ap_logs,
