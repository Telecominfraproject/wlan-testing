...
pytestmark = [pytest.mark.regression, pytest.mark.dynamic_vlan, pytest.mark.wpa2_enterprise, pytest.mark.bridge,pytest.mark.fiveg]
...
class TestDynamicVlan(object):
    ...
    @pytest.mark.fiveg
    @allure.testcase(name="test_dynamic_absence_of_radius_vlan_identifier",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-5704")
    def test_dynamic_absence_of_radius_vlan_identifier(self, get_vif_state, lf_tools,
                                                       create_lanforge_chamberview_dut, lf_test, get_configuration,
                                                       station_names_fiveg):
        """
                pytest -m " absenceofradiusvlanttidentifier and wpa2_enterprise and bridge"
        """
    ...
    def test_dynamic_invalid_vlan(self, get_vif_state, lf_tools,
                                  create_lanforge_chamberview_dut, lf_test, get_configuration,
                                  station_names_fiveg):
        """
                pytest -m "test_dynamic_invalid_vlan and wpa2_enterprise and bridge"
        """
    ...
    @pytest.mark.wpa2_enterprise
    @pytest.mark.fiveg
    @allure.testcase(name="test_dynamic_periodic_reauthentication_vlan",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-5707")
    def test_dynamic_periodic_reauthentication_vlan(self, get_vif_state, lf_tools,
                                                    create_lanforge_chamberview_dut, lf_test, get_configuration,
                                                    station_names_fiveg):
        """
                pytest -m "periodic_reauthentication and wpa2_enterprise and bridge"
        """
    ...
    @pytest.mark.wpa2_enterprise
    @pytest.mark.fiveg
    @allure.testcase(name="test_dynamic_absence_of_vlanid",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-5708")
    def test_dynamic_absence_of_vlanid(self, get_vif_state, lf_tools,
                                       create_lanforge_chamberview_dut, lf_test, get_configuration,
                                       station_names_fiveg):
        """
                pytest -m "absenceofvlanid and wpa2_enterprise and bridge"
        """
    ...
    def test_dynamic_unsupported_vlan(self, get_vif_state, lf_tools,
                                      ...
                                      station_names_fiveg):
        """
                pytest -m "unsupported and wpa2_enterprise and bridge"
        """
    ...
    @pytest.mark.wpa2_enterprise
    @pytest.mark.fiveg
    @allure.testcase(name="test_dynamic_outof_bound_vlanid",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-5711")
    def test_dynamic_outof_bound_vlanid(self, get_vif_state, lf_tools,
                                        create_lanforge_chamberview_dut, lf_test, get_configuration,
                                        station_names_fiveg):
        """
                pytest -m "outofboundvlanid and wpa2_enterprise and bridge"
        """
    ...
    @pytest.mark.wpa2_enterprise
    @pytest.mark.fiveg
    @allure.testcase(name="test_subsequent_user_for_same_user_account_vlan",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-5705")
    def test_subsequent_user_for_same_user_account_vlan(self, get_vif_state, lf_tools,
                                                        create_lanforge_chamberview_dut, lf_test,
                                                        get_configuration,
                                                        station_names_fiveg):
        """
                pytest -m "subsequent_user_for_same_user_account and wpa2_enterprise and bridge"
        """
    ...
    def test_subsequent_user_for_different_user_account_vlan(self, get_vif_state, lf_tools,
                                                             create_lanforge_chamberview_dut, lf_test,
                                                             get_configuration,
                                                             station_names_fiveg):
        """
                pytest -m "subsequent_user_for_different_user_account and wpa2_enterprise and bridge"
        """
