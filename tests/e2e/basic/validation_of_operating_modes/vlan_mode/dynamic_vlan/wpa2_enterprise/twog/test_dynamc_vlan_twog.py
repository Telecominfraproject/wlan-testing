...
class TestDynamicVlan(object):
    ...
    @pytest.mark.twog
    @allure.testcase(name="test_dynamic_vlan_in_the_absence_of_radius_vlan_identifier",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-5704")
    def test_dynamic_vlan_in_the_absence_of_radius_vlan_identifier(self, get_vif_state, lf_tools,get_ap_logs,
                                                                   get_lf_logs,
    ...
    def test_dynamic_invalid_vlan(self, get_vif_state, lf_tools,get_ap_logs,get_lf_logs,
                                  create_lanforge_chamberview_dut, lf_test, get_configuration,
                                  station_names_twog):
        """
    ...
    def test_dynamic_absence_of_vlanid(self, get_vif_state, lf_tools,get_ap_logs,get_lf_logs,
                                       create_lanforge_chamberview_dut, lf_test, get_configuration,
                                       station_names_twog):
        """
                pytest -m "dynamic_vlan and wpa2_enterprise and vlan"
    ...
    def test_dynamic_outof_bound_vlanid(self, get_vif_state, lf_tools,get_ap_logs,get_lf_logs,
                                        create_lanforge_chamberview_dut, lf_test, get_configuration,
                                        station_names_twog):
        """
                pytest -m "dynamic_vlan and wpa2_enterprise and vlan"
    ...
    def test_subsequent_user_for_same_user_account_vlan(self, get_vif_state, lf_tools,get_ap_logs,get_lf_logs,
    ...
    def test_subsequent_user_for_different_user_account_vlan(self, get_vif_state, lf_tools,get_ap_logs,get_lf_logs,
                                                             create_lanforge_chamberview_dut, lf_test,
                                                             get_configuration,
                                                             station_names_twog):
        """
