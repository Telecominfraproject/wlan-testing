...
class TestMultiVlan(object):
    ...
    def test_multi_vlan_open_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
        To verify that a client operating with open security will connect or not using multi vlans in 2.4GHz band.

        Unique Marker:
        multi_vlan_tests and twog and open
        """
    ...
    def test_multi_vlan_wpa_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        """
        To verify that a client operating with wpa security will connect or not using multi vlans in 2.4GHz band.

        Unique Marker:
        multi_vlan_tests and twog and wpa
        """
    ...
    def test_multi_vlan_wpa2_personal_2g(self, get_test_library, get_dut_logs_per_test_case,
                                         get_test_device_logs, num_stations, setup_configuration, check_connectivity):
        """
        To verify that a client operating with wpa2 (personal) security will connect or not using multi vlans in
        2.4GHz band.

        Unique Marker:
        multi_vlan_tests and twog and wpa2_personal
        """
    ...
    def test_multi_vlan_wpa_wpa2_personal_2g(self, get_test_library, get_dut_logs_per_test_case,
                                             get_test_device_logs, num_stations, setup_configuration):
        """
        To verify that a client operating with wpa mixed(personal) security will connect or not using multi vlans in
        2.4GHz band.

        Unique Marker:
        multi_vlan_tests and twog and wpa_wpa2_personal_mixed
        """
    ...
    def test_disable_vlan_wpa2_2g(self, get_test_library, get_dut_logs_per_test_case,
        ...
        Unique Marker:
        multi_vlan_tests and twog and wpa2_personal and disable_vlan_twog
        """
        profile_data = {"ssid_name": "ssid_wpa2_2g", "appliedRadios": ["2G"], "security_key": "something", "vlan": 200}
        ssid_name = profile_data["ssid_name"]
        security_key = profile_data["security_key"]
