...
class TestClientIsolationEnabled(object):
    ...
    def test_client_isolation_enabled_ssid_5g(self, lf_test, lf_tools, update_report, get_configuration):
        ...
        cx_data = lf_test.allure_report_table_format(dict_data=rx_data[f"{cx_list[0]}"], key="KEY", value="VALUE",
                                                           name="cx_data")
        print("CX_DATA ",cx_data)
    ...
    def test_client_isolation_enabled_with_2g(self, lf_test, lf_tools, update_report, get_configuration):
    ...
    def test_client_isolation_enabled_ssids_2g(self,lf_test, lf_tools, update_report, get_configuration):
    ...
    def test_client_isolation_enabled_with_5g(self, lf_test, lf_tools, update_report, get_configuration):
...
class TestClientIsolationDisabled(object):
    ...
    def test_client_isolation_disabled_ssids_2g(self, lf_test, lf_tools, update_report, get_configuration):
    ...
    def test_client_isolation_disabled_with_2g(self, lf_test, lf_tools, update_report, get_configuration):
    ...
    def test_client_isolation_disabled_ssid_5g(self,lf_test, lf_tools, update_report, get_configuration):
    ...
    def test_client_isolation_disabled_with_5g(self, lf_test, lf_tools, update_report, get_configuration):
...
class TestClientIsolationSameSSID(object):
    ...
    def test_cleint_isolation_enabled_same_ssid_2g(self, lf_test, lf_tools, update_report, get_configuration):
    ...
    def test_cleint_isolation_disabled_same_ssid_2g(self,lf_test, lf_tools, update_report, get_configuration):
    ...
    def test_cleint_isolation_enabled_same_ssid_5g(self, lf_test, lf_tools, update_report, get_configuration):
    ...
    def test_cleint_isolation_disabled_same_ssid_5g(self, lf_test, lf_tools, update_report, get_configuration):
...
class TestClientIsolationDifferentSSID(object):
    ...
    def test_client_isolation_disabled_ssid_2g_enabled_ssid_5g(self, lf_test, lf_tools, update_report,test_cases,
        ...
        sta = lf_test.attach_stationdata_to_allure(station_name=station_list1,name="")
        print(sta)
        std = lf_test.attach_stationdata_to_allure(station_name=station_list2,name="")
        # sta_final = lf_test.allure_report_table_format(dict_data={sta_list}, key="station list ", value="value",
        #                                                    name="station_details")
        # print("Allure results:",sta_final)
        allure.attach(name="Min Tx rate -A", body="6291456 (6.2 Mbps)")
        allure.attach(name="Min Tx rate -B", body="0 (zero)")
        layer3_restult = lf_test.create_layer3(side_a_min_rate=6291456, side_a_max_rate=0,
                                               side_b_min_rate=0, side_b_max_rate=0,
        ...
        cx_data = lf_test.allure_report_table_format(dict_data=rx_data[f"{cx_list[0]}"], key="KEY", value="VALUE",
                                                           name="cx_data")
        print("Rx data_values are : ",cx_data)
