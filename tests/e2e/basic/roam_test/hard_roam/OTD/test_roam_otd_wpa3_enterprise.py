...
class TestRoamOTD(object):
    ...
    def test_roam_2g_to_2g_wpa3eap_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed,
                                      radius_info):
        """
    ...
    @pytest.mark.fiveg
    @pytest.mark.same_channel
    def test_roam_5g_to_5g_wpa3eap_sc(self, get_target_object, get_test_library, get_lab_info, selected_testbed,
                                      radius_info):
        """
