...
pytestmark = [pytest.mark.multicast_test, pytest.mark.bridge]
...
@allure.suite("Multicast Test with Power Save")
...
class TestMulticastwithPowerSave(object):
    ...
    #                                          get_lf_logs):
    def test_multicast_with_power_save_fiveg(self, get_configuration, lf_test, station_names_fiveg, lf_tools,
        ...
        band = "fiveg"
        vlan = 1
        end_result = lf_test.verify_multicast_downstream_with_powersave(instantiate_profile, get_configuration,
                                                                        ssid=ssid_name, password=security_key,
    ...
    #                                          instantiate_profile, get_controller_logs, get_ap_config_slots,
    #                                          get_lf_logs):
    def test_multicast_with_power_save_twog(self, get_configuration, lf_test, station_names_twog, lf_tools,
                                            run_lf, test_duration,
                                            add_env_properties,
                                            instantiate_profile, get_controller_logs, get_ap_config_slots,
                                            get_lf_logs):
    ...
    #                                          instantiate_profile, get_controller_logs, get_ap_config_slots,
    #                                          get_lf_logs):
    def test_multicast_with_power_save_sixg(self, get_configuration, lf_test, station_names_ax, lf_tools,
                                            run_lf, test_duration,
                                            add_env_properties,
                                            instantiate_profile, get_controller_logs, get_ap_config_slots,
                                            get_lf_logs):
        ...
        band = "sixg"
        vlan = 1
        end_result=lf_test.verify_multicast_downstream_with_powersave(instantiate_profile, get_configuration, ssid=ssid_name,
                                                           password=security_key, security=security_type,
