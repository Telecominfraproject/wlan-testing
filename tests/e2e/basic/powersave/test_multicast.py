...
class TestMulticastwithPowerSave(object):
    ...
    def test_multicast_with_power_save_fiveg(self, get_configuration, lf_test,station_names_fiveg, lf_tools,
        ...
        band = "fiveg"
        vlan = 1
        lf_test.verify_multicast_downstream_with_powersave(instantiate_profile,get_configuration,ssid=ssid_name, password=security_key,security=security_type,
    ...
    def test_multicast_with_power_save_twog(self, get_configuration, lf_test, station_names_twog, lf_tools,
        ...
        band = "twog"
        vlan = 1
        lf_test.verify_multicast_downstream_with_powersave(instantiate_profile, get_configuration, ssid=ssid_name,
